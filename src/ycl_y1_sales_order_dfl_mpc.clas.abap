class YCL_Y1_SALES_ORDER_DFL_MPC definition
  public
...
public section.
  ...
  types:
    begin of MESSAGECOMPLEX,
        TYPE type C length 1,
        MESSAGE type C length 255,
    end of MESSAGECOMPLEX .
  types:
  ...
  types:
    begin of TS_UPDATE_ORDER_STATUS,
        SALESORDERID type I,
        STATUS type string,
    end of TS_UPDATE_ORDER_STATUS .
  types:
...
TT_RETURNMESSAGE type standard table of TS_RETURNMESSAGE .
  ...
  constants GC_MESSAGECOMPLEX type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'MessageComplex' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'YCL_Y1_SALES_ORDER_DFL_MPC====CP' ##NO_TEXT.
...
CLASS YCL_Y1_SALES_ORDER_DFL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Y1_SALES_ORDER_DFLC_SRV' ).
...
lo_action = model->create_action( 'UPDATE_ORDER_STATUS' ).  "#EC NOTEXT
*Set return complex type
lo_action->set_return_complex_type( 'MessageComplex' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'YCL_Y1_SALES_ORDER_DFL_MPC=>TS_UPDATE_ORDER_STATUS' ). "#EC NOTEXT
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'SalesOrderHeaderToSalesOrderItem' "#EC NOTEXT
                            iv_left_type        = 'SalesOrderHeader' "#EC NOTEXT
                            iv_right_type       = 'SalesOrderItem' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SalesOrderHeaderToSalesOrderItem
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'SalesOrderID'   iv_dependent_property = 'SalesOrderID' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SalesOrderHeaderToSalesOrderItems'                         "#EC NOTEXT
...
***********************************************************************************************************************************
*   COMPLEX TYPE - MessageComplex
***********************************************************************************************************************************
lo_complex_type = model->create_complex_type( 'MessageComplex' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'YCL_Y1_SALES_ORDER_DFL_MPC=>MESSAGECOMPLEX' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'YCL_Y1_SALES_ORDER_DFL_MPC=>TS_RETURNMESSAGE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ReturnMessages' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesOrderID' iv_abap_fieldname = 'ORDERID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CreationDateTime' iv_abap_fieldname = 'CREATION_DATE_TIME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CreatedBy' iv_abap_fieldname = 'CREATION_USER' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalItems' iv_abap_fieldname = 'TOTALITEMS' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalFreight' iv_abap_fieldname = 'TOTALFREIGHT' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalOrder' iv_abap_fieldname = 'TOTALORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'YCL_Y1_SALES_ORDER_DFL_MPC=>TS_SALESORDERHEADER' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesOrderItemNumber' iv_abap_fieldname = 'ITEMID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'YCL_Y1_SALES_ORDER_DFL_MPC=>TS_SALESORDERITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251020125217'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'CreationDateTime'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesOrderHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TotalItems'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesOrderHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TotalFreight'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesOrderHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TotalOrder'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesOrderHeader'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesOrderItemNumber'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SalesOrderItem'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ReturnMessage'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
