class YCL_Y1_SALES_ORDER_DFL_DPC definition
  public
...
protected section.
  ...
  methods RETURNMESSAGES_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type YCL_Y1_SALES_ORDER_DFL_MPC=>TS_RETURNMESSAGE
    raising
  ...
  methods RETURNMESSAGES_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type YCL_Y1_SALES_ORDER_DFL_MPC=>TT_RETURNMESSAGE
  ...
  methods SALESORDERHEADER_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type YCL_Y1_SALES_ORDER_DFL_MPC=>TS_SALESORDERHEADER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERHEADER_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type YCL_Y1_SALES_ORDER_DFL_MPC=>TT_SALESORDERHEADER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERITEMS_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type YCL_Y1_SALES_ORDER_DFL_MPC=>TS_SALESORDERITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERITEMS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type YCL_Y1_SALES_ORDER_DFL_MPC=>TT_SALESORDERITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS YCL_Y1_SALES_ORDER_DFL_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 20.10.2025 14:52:25 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - YCL_Y1_SALES_ORDER_DFL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderheader_create_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderheader.
 DATA salesorderitems_create_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderitem.
 DATA returnmessages_create_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_returnmessage.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ReturnMessages
*-------------------------------------------------------------------------*
     WHEN 'ReturnMessages'.
*     Call the entity set generated method
    returnmessages_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = returnmessages_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = returnmessages_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderheader_get_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderheader.
 DATA salesorderitems_get_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderitem.
 DATA returnmessages_get_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_returnmessage.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          returnmessages_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = returnmessages_get_entity
                         es_response_context = es_response_context
          ).

        IF returnmessages_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = returnmessages_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - YCL_Y1_SALES_ORDER_DFL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderheader_get_entityset TYPE ycl_y1_sales_order_dfl_mpc=>tt_salesorderheader.
 DATA salesorderitems_get_entityset TYPE ycl_y1_sales_order_dfl_mpc=>tt_salesorderitem.
 DATA returnmessages_get_entityset TYPE ycl_y1_sales_order_dfl_mpc=>tt_returnmessage.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      returnmessages_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = returnmessages_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = returnmessages_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderheader_update_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderheader.
 DATA salesorderitems_update_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_salesorderitem.
 DATA returnmessages_update_entity TYPE ycl_y1_sales_order_dfl_mpc=>ts_returnmessage.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          returnmessages_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = returnmessages_update_entity
          ).
       IF returnmessages_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = returnmessages_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
